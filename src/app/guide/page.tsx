      ...
      <main className="w-full max-w-2xl">
        ...
        <div className="mt-6 flex flex-col gap-5 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
          ...
          <section>
            ...
            <p>
              지금까지 발행된 요약을 날짜별로 모아볼 수 있어요. 로그인이나 구독 없이도 누구나
              자유롭게 열람할 수 있어요.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              원하시는 금액으로 매달 자동 결제되는 자율구독이에요. 구독하시면 광고 없는 화면으로
              이용할 수 있고, 앞으로 선보일 키워드 검색 요약 기능도 구독자에게 가장 먼저
              열립니다. 무엇보다 정론관이 광고 없이도 꾸준히 운영될 수 있도록 돕는 후원이 됩니다.
            </p>
          </section>
