...
export default async function MembersPage({
  ...
  return (
    <div className="min-h-screen bg-zinc-50 px-4 py-16 dark:bg-black">
      <div className="mx-auto w-full max-w-7xl members-layout">
        ...
        <aside className="members-bills flex w-full shrink-0 flex-col gap-6">
          <BillRankPanel
            icon="🆕"
        ...
        <aside className="members-top10 w-full shrink-0">
