...
export async function generateDailySummary(log: (msg: string) => void = console.log) {
  log("1/6 정치 뉴스 헤드라인 수집 중...");
  ...
  return { cardId: card.id as string, publishedDate, issueTitle: issue.issue_title };
}
